...
MySQL 的学习路线戳：[MySQL 的学习四阶段](../xuexiluxian/mysql.html)
...
可以使用 [Homebrew](../gongju/brew.html) 来安装 MySQL，但这里为了和 Windows 安装匹配，我们这里依然使用官网下载安装包的方式。
...
如果使用 Homebrew 安装的话，可以问一下 [wrap](../gongju/warp.html) AI。
